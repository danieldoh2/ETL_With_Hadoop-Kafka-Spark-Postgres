...
from your_script import process_message, connect_db, create_table
...
@patch('your_script.psycopg2.connect')
...
# To run the test, save this script as test_your_script.py and run `pytest` in the terminal.
