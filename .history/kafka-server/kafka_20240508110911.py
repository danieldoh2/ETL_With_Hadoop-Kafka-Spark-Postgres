...
if __name__ == '__main__':
    # sqlalchemy_connect()
    event_str = '{"EventType": "general_health_report", "Timestamp": "2024-05-08 15:06:53", "Location": "Los Angeles", "Severity": "medium", "Details": "This is a simulated general_health_report event."}'
    new_str = event_str.split(',')
    print(new_str)
    # basic_consume()
